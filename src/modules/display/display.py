...
class LoggerConfig:
    ...
    PROPAGATE = True
    LEVEL: ty.Literal['CRITICAL', 'FATAL', 'ERROR', 'WARN', 'WARNING', 'INFO', 'DEBUG', 'NOTSET'] = 'DEBUG'
    STDERR = None
...
class _Logger:
    ...
    def __create_logger(self,
        ...
        stream_handler = logging.StreamHandler(LoggerConfig.STDERR)
    ...
    def warning(self, msg: str='', *args, **kwargs) -> None:
        ...
        """
        self._mess.warning(msg.encode('charmap', errors='ignore').decode('charmap'), *args, **kwargs)
    ...
    def debug(self, msg: str='', *args, **kwargs) -> None:
        ...
        """
        self._mess.debug(msg.encode('charmap', errors='ignore').decode('charmap'), *args, **kwargs)

    def error(self, msg: str='', *args, skippable: bool=True, base_error: Exception | None=None, **kwargs) -> None:
        """
